...
<div class="input-style-1">
   ...
   <textarea type="text" class="form-control <?= ($validation->hasError('alamat_lokasi')) ? 'is-invalid' :  '' ?>" name="alamat_lokasi" placeholder="Alamat Lokasi"></textarea>
   ...
   <label>Zona Waktu</label>
     <select name="zona_waktu" class="form-control <?= ($validation->hasError('zona_waktu')) ? 'is-invalid' :  '' ?>" name="zona_waktu">
